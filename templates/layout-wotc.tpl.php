...
<div id="wrap">
  ...
  <div id="content-wrap"> 
    ...
    <div id="content">
      ...
      <?php if ($title): ?>
        <h2 class="node-title"><?php print $title; ?></h1>
      <?php endif; ?>
  ...
  <?php endif; ?>     
    ...
    <div id="footer">
			<p><span class="license">Content on this site is licensed under a <a href="http://creativecommons.org/licenses/by/3.0/us/" target="_blank">Creative Commons Attribution 3.0 License</a>.</span> <span class="attribution">Website by <a href="http://pattrn.org" target="_blank">Pattrn</a>.</span></p>
    </div>
  </div>
